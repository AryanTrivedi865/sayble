...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      onPrimaryContainer: Color(0xfffdfafa),
      ...
      tertiaryContainer: Color(0xff575656),
      onTertiaryContainer: Color(0xfffefafa),
      ...
      onTertiaryFixedVariant: Color(0xff474646),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryFixedDim: Color(0xff5d5c5b),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff2d2d2c),
      onSecondaryFixedVariant: Color(0xffffffff),
  ...
  static MaterialScheme darkScheme() {
    return const MaterialScheme(
      ...
      onPrimaryContainer: Color(0xffd2d0d0),
      ...
      tertiaryContainer: Color(0xff3f3e3e),
      onTertiaryContainer: Color(0xffd5d2d1),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryContainer: Color(0xffcdcaca),
      onTertiaryContainer: Color(0xff000000),
